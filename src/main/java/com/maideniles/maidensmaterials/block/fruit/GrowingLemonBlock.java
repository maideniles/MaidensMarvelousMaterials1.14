...
public class GrowingLemonBlock extends BushBlock implements IGrowable {
    ...
    public GrowingLemonBlock(Block.Properties p_i49971_1_) {
        super(p_i49971_1_);
    ...
    protected boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
        ...
        return block == Blocks.AIR ||block.isIn(BlockTags.LOGS) || block == Blocks.DIRT || block == ModBlocks.lemonLeaves.get()|| block == Blocks.COARSE_DIRT || block == Blocks.PODZOL || block == Blocks.FARMLAND || block == Blocks.SAND || block.isIn(BlockTags.LEAVES);
    }
