...
public class GrowingPeachBlock extends BushBlock implements IGrowable {
    ...
    public GrowingPeachBlock(Block.Properties p_i49971_1_) {
        super(p_i49971_1_);
    ...
    protected boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
        ...
        return block == Blocks.AIR ||block.isIn(BlockTags.LOGS) || block == Blocks.DIRT || block == ModBlocks.peachLeaves.get()|| block == Blocks.COARSE_DIRT || block == Blocks.PODZOL || block == Blocks.FARMLAND || block == Blocks.SAND || block.isIn(BlockTags.LEAVES);
    }
    ...
    public boolean onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        ...
        if (!flag && player.getHeldItem(handIn).getItem() == Items.BONE_MEAL) {
            ...
            spawnAsEntity(worldIn, pos, new ItemStack(ModItems.PEACH.get(), j + (flag ? 1 : 0)));
