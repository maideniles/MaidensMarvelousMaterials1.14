...
public class BlockJadeLeaves extends LeavesBlock {
    public BlockJadeLeaves(Properties properties) {
    ...
    public boolean onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        ...
        if (!worldIn.isRemote()) {
            ...
            if (shears.getItem() == ModItems.PRUNING_SHEARS) {
                ...
                ItemEntity blossom = new ItemEntity(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(ModItems.JADE_BLOSSOMS, 1));
