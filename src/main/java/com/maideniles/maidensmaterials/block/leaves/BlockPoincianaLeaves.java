...
public class BlockPoincianaLeaves extends LeavesBlock {
    public BlockPoincianaLeaves(Properties properties) {
    ...
    public boolean onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        ...
        if (!worldIn.isRemote()) {
            ...
            if (shears.getItem() == ModItems.PRUNING_SHEARS.get()) {
                ...
                ItemEntity blossom = new ItemEntity(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(ModItems.POINCIANA_BLOSSOMS.get(), 1));
