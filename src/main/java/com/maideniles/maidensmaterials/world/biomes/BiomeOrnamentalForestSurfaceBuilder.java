...
public class BiomeOrnamentalForestSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {

    public BiomeOrnamentalForestSurfaceBuilder(Function<Dynamic<?>, ? extends SurfaceBuilderConfig> function) {
        super(function);
    }
