...
public class BiomeOrnamentalOrchardSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {

    public BiomeOrnamentalOrchardSurfaceBuilder(Function<Dynamic<?>, ? extends SurfaceBuilderConfig> function) {
        super(function);
    }
